...
class UserProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final wishlist = _asList(userData['wishlist']);
    final played = _asList(userData['played']);
    final favorites = _asList(userData['favorites']);
    final username = (userData['username'] ?? 'Player').toString().trim();
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
            _buildProfileHeader(
              username: username.isNotEmpty ? username : 'Player',
  ...
  Widget _buildStatsTab(List played) {
    if (played.isEmpty) {
      return _buildEmptyState(
        ...
        subtitle: 'Statistik akan muncul setelah user punya game yang sudah dimainkan.',
        color: AppTheme.primaryColor,
      );
    }
  ...
  _ListUiConfig _listConfig(String listType) {
    if (listType == 'wishlist') {
      return const _ListUiConfig(
        ...
        emptySubtitle: 'Game yang ingin dimainkan user akan muncul di sini.',
      );
    }
    ...
    if (listType == 'played') {
      return const _ListUiConfig(
        ...
        emptySubtitle: 'Game yang sudah dimainkan user akan tampil di sini.',
      );
    }
    ...
    return const _ListUiConfig(
      ...
      emptySubtitle: 'Game favorit user akan muncul di bagian ini.',
    );
  }
